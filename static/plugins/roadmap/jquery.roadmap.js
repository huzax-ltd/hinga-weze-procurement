            ...
            var buildNavigation = function () {
                ...
                var buildNav = function (nav) {
                    switch (nav) {
                        case 'prev':
                            if (currentSlide > 0) {
                                return $('<li><a href="#" class="' + nav + '" style="text-decoration: unset;">' + settings.prevArrow + '</a></li>');
                            }
                            break;

                        case 'next':
                            if ((currentSlide + 1) * settings.eventsPerSlide < events.length) {
                                return $('<li><a href="#" class="' + nav + '" style="text-decoration: unset;">' + settings.nextArrow + '</a></li>');
                            }
                            break;
                    }
