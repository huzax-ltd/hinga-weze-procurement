# Generated by Django 2.1.3 on 2019-03-19 18:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('', '--select--'), ('pending', 'Pending'), ('approved', 'Approved'),
                                            ('rejected', 'Rejected')], default='pending', max_length=255,
                                   verbose_name='Status'),
        ),
        migrations.AlterField(
            model_name='orders',
