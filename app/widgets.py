...
class ReallySimpleColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/really-simple/colorPicker.css',)}
...
class BootstrapColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/bootstrap/css/bootstrap.min.css',
                       STATIC_URL_BASE + 'plugins/color_utils/bootstrap/css/colorpicker.css',)}
        js = ('//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
              STATIC_URL_BASE + 'plugins/color_utils/bootstrap/js/bootstrap-colorpicker.js',)
...
class PhotoshopColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/photoshop/css/colorpicker.css',)}
        js = ('//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
...
class SimpleColorPicker(forms.TextInput):
    ...
    class Media:
        js = ('//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
              STATIC_URL_BASE + 'plugins/color_utils/simplecolor/jquery.simple-color.min.js',)
...
class FarbtasticColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/farbtastic/farbtastic.css',)}
        js = ('//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
...
class jPickerColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/jpicker/css/jpicker-1.1.6.min.css',)}
        js = ('//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js',
...
class MooRainbowColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/moorainbow/mooRainbow.css',)}
        js = (STATIC_URL_BASE + 'plugins/color_utils/moorainbow/mootools.v1.11.js',
...
class MenuCoolColorPicker(forms.TextInput):
    ...
    class Media:
        css = {'all': (STATIC_URL_BASE + 'plugins/color_utils/menucool/mcColorPicker.css',)}
