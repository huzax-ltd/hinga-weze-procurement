...
class Utils(object):
    ...
    HTML_TAG_ORDER_STATUS_IN_PROGRESS = '<div class=\'center-block\' style=\'background-color:' + settings.COLOR_ORANGE + ';color:#FFFFFF;width:100px;text-align: center;\'><b> In Progress <b></div>'
